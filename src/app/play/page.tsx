          ...
          controls: [
            {
              name: 'rotate-left',
              position: 'right',
              html: '<i class="art-icon flex"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"><path d="M12 3a8.959 8.959 0 0 0-7 3.339V4H3v6h6V8H6.274a6.982 6.982 0 1 1-1.054 5.751l-1.936.5A9 9 0 1 0 12 3z"/></svg></i>',
              tooltip: '左转90°',
              click: function () {
                applyRotation(rotateDeg.current - 90);
              },
            },
            {
              name: 'rotate-right',
              position: 'right',
              html: '<i class="art-icon flex"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"><path d="M15 10h6V4h-2v2.339a9 9 0 1 0 1.716 7.91l-1.936-.5A7.028 7.028 0 1 1 17.726 8H15z"/></svg></i>',
              tooltip: '右转90°',
              click: function () {
                applyRotation(rotateDeg.current + 90);
              },
